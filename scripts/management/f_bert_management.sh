...
TASK='IPO'
TRAIN_DATASET='/media/SSD_2TB/financial_data/dataset_end/balanced/management/dataset-management-train.json'
EVAL_DATASET='/media/SSD_2TB/financial_data/dataset_end/balanced/management/dataset-management-eval.json'
TEST_DATASET='/media/SSD_2TB/financial_data/dataset_end/balanced/management/dataset-management-test.json'
LEARNING_RATE=1e-5
EPOCHS=10
MAX_POOLED=false
FINANCIAL=true
EMBEDDING_REDUCTION_FEATURES=12
