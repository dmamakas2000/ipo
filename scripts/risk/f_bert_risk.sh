...
TASK='IPO'
TRAIN_DATASET='/media/SSD_2TB/financial_data/dataset_end/balanced/risk/dataset-risk-train.json'
EVAL_DATASET='/media/SSD_2TB/financial_data/dataset_end/balanced/risk/dataset-risk-eval.json'
TEST_DATASET='/media/SSD_2TB/financial_data/dataset_end/balanced/risk/dataset-risk-test.json'
LEARNING_RATE=1e-5
EPOCHS=10
MAX_POOLED=false
FINANCIAL=true
